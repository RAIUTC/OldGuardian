...
import com.example.oldguard_guardianver.Request.EditGuestInfoRequest
...
class PartternPhachActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState : Bundle?) {
        ...
        viewBinding.saveBtn.setOnClickListener {
            ...
            //레트로핏 사용하는 코드 써주세요
            var request = EditGuestInfoRequest(callTime,emergencyTime ,0L, messageTime, sleepEndTime.toString(), sleepStartTime.toString())
